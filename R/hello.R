...
#'Replicating coursera's 'Building R packages' demo code
#'
...
#'@param y a vector of length n representing the reponse
...
#'and calculates a pvalue indicating the significance of the association.
...
#'and makes a prediction for each of the values provided in the input X
#'matrix
#'
...
#'@return a numeric vector containing the predictor values
#'@export
